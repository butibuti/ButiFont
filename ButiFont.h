...
public:
	virtual const ButiFont::FontGlyph* * FindGlyphs_utf8(const char* arg_srcStr, int& arg_ref_glyphSize) const= 0;
...
/// <returns></returns>
extern BUTIFONT_API void LoadTTF(const char* arg_filePath, const int size, ButiFont::FontLanguage arg_lang,  int* arg_output_width,  int* arg_output_height,unsigned char** arg_output_atlasTextureData, IFontInformation** arg_output_fontInfo);
/// <summary>
/// ButiFontが確保したメモリの解放
/// </summary>
